...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (checkLockScreen()) {
            ...
            if (initCipher()) {
                ...
                if (fingerprintManager != null && mCryptoObject != null) {
    ...
    private fun checkLockScreen(): Boolean {
        ...
        var text = getString(R.string.activity_login__lock_screen_not_enabled)
        ...
        text = getString(R.string.activity_login__fingerprint_permission_not_enabled)
        if (permission != PackageManager.PERMISSION_GRANTED) {
            Toast.makeText(this, text, Toast.LENGTH_LONG).show()
            return false
        }

        text = getString(R.string.activity_login__no_fingerprint_registered)
