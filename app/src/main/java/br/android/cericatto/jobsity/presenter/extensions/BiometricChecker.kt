...
sealed class BiometricChecker {
    ...
    private class QBiometricChecker(private val biometricManager: BiometricManager): BiometricChecker() {
    ...
    @Suppress("DEPRECATION")
    private class LegacyBiometricChecker(private val fingerprintManager: FingerprintManager
    ) : BiometricChecker() {
        override val hasBiometrics: Boolean
